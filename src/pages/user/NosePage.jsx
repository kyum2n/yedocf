...
const renderNoseContent = (tab) => {
  switch (tab) {
    case '1': return <div className='h-[1500px] w-[1200px] bg-red-50 text-center font-bold'>콧대 성형</div>;
    case '2': return <div className='h-[1500px] w-[1200px] bg-red-100 text-center font-bold'>매부리코 성형</div>;
    case '3': return <div className='h-[1500px] w-[1200px] bg-red-200 text-center font-bold'>복코 교정</div>;
    case '4': return <div className='h-[1500px] w-[1200px] bg-red-300 text-center font-bold'>코끝 성형</div>;
    case '5': return <div className='h-[1500px] w-[1200px] bg-red-400 text-center font-bold'>콧볼 축소</div>;
